export interface CourseDay {
  ...
  vocabulary: { word: string; meaning: string; hindi: string }[];
  sentences: { english: string; hindi: string }[];
  tip: string;
}
...
export const courseData: CourseDay[] = [
  // === Day 1-5: Basic Greetings, Introductions, Simple Present ===
  {
    ...
    grammarConcept:
      "Simple Present Tense (Verb 'to be'): Used to state facts and introduce yourself. Structure: I am / You are / He is / She is / We are / They are.",
    vocabulary: [
  ...
  },
  {
    ...
    grammarConcept:
      "Simple Present Tense with 'I am / My name is': Use this to introduce yourself. Pattern: 'I am [name]. I am from [place]. I am [age] years old.'",
    vocabulary: [
  ...
  },
  {
    ...
    grammarConcept:
      "Possessive Pronouns (My, Your, His, Her, Our, Their): Used to show belonging. Example: 'This is my mother.' / 'Her brother is tall.'",
    vocabulary: [
  ...
  },
  {
    ...
    grammarConcept:
      "Adjectives in Simple Present: Adjectives come before nouns. Structure: 'The [adjective] [noun] is/are...' Example: 'The red car is fast.' / 'Three blue books are on the table.'",
    vocabulary: [
  ...
  },
  {
    ...
    grammarConcept:
      "Simple Present Tense (Regular Verbs): For he/she/it, add -s or -es. Pattern: 'He works / She teaches / It runs.' For I/You/We/They: no change. 'I work / They teach.'",
    vocabulary: [
  ...
  // === Day 6-10: Daily Routines, Present Continuous, Asking Questions ===
  {
    ...
    grammarConcept:
      "Simple Present for Routines: Use adverbs of frequency — always, usually, often, sometimes, never. Example: 'I always wake up at 6 AM.' / 'She never eats junk food.'",
    vocabulary: [
  ...
  },
  {
    ...
    grammarConcept:
      "Present Continuous (am/is/are + verb-ing): Used for actions happening right now. Structure: Subject + am/is/are + [verb + ing]. Example: 'I am reading.' / 'They are playing cricket.' Negative: 'She is not sleeping.'",
    vocabulary: [
      {
        word: "Running",
  ...
  },
  {
    ...
    grammarConcept:
      "Yes/No Questions with 'do/does' and 'am/is/are': Flip the subject and auxiliary. 'You are happy' → 'Are you happy?' / 'She eats rice' → 'Does she eat rice?' Answer: Yes, she does. / No, she doesn't.",
    vocabulary: [
      {
        word: "Do",
  ...
  },
  {
    ...
    topic: "WH-Questions",
    grammarConcept:
      "WH-Questions: What (क्या), Who (कौन), Where (कहाँ), When (कब), Why (क्यों), How (कैसे). Structure: WH word + auxiliary (do/does/is/are) + subject + verb? Example: 'Where do you live?' / 'Why is she crying?'",
    vocabulary: [
  ...
  },
  {
    ...
    grammarConcept:
      "Using 'How much / How many': 'How much' for uncountable nouns (water, money, rice). 'How many' for countable nouns (apples, books, chairs). Example: 'How much does it cost?' / 'How many apples do you want?'",
    vocabulary: [
  ...
  // === Day 11-15: Past Tense, Telling Stories, Time Expressions ===
  {
    ...
    grammarConcept:
      "Simple Past Tense: Used for completed actions in the past. Regular verbs: add -ed. 'walk → walked', 'talk → talked'. Irregular verbs: change form. 'go → went', 'eat → ate', 'see → saw'. Negative: 'did not + base verb'. 'I did not go.'",
    vocabulary: [
      {
        word: "Yesterday",
  ...
  },
  {
    ...
    grammarConcept:
      "Common Irregular Past Verbs: go→went, come→came, see→saw, give→gave, take→took, make→made, know→knew, think→thought, feel→felt, buy→bought. These must be memorized — there is no rule pattern.",
    vocabulary: [
      {
        word: "Childhood",
  ...
  },
  {
    ...
    grammarConcept:
      "Story Linking Words (Sequencers): Use these to connect past events: First, Then, After that, Next, Finally, Suddenly, Meanwhile, Eventually. Example: 'First, I went to the market. Then, I bought vegetables. Finally, I cooked dinner.'",
    vocabulary: [
      {
        word: "First",
  ...
  },
  {
    ...
    grammarConcept:
      "Past Perfect (had + past participle): Used when one past action happened before another past action. 'I had already eaten when she arrived.' The earlier action uses past perfect. Structure: Subject + had + [verb3]. Negative: 'He had not finished.'",
    vocabulary: [
      {
        word: "Already",
  ...
  },
  {
    ...
    grammarConcept:
      "Time Expressions: Past — yesterday, last week/month/year, ago (two days ago, a week ago). Present — now, today, at the moment, currently. Future — tomorrow, next week/month, soon, in [time] (in two days). Match the tense with the time expression!",
    vocabulary: [
      {
        word: "Ago",
  ...
  // === Day 16-20: Future Tense, Making Plans, Modal Verbs ===
  {
    ...
    grammarConcept:
      "Simple Future with 'will': Use 'will + base verb' for decisions, promises, and predictions. 'I will help you.' / 'It will rain tomorrow.' Negative: 'will not' (won't). Question: 'Will you come?' Short answer: 'Yes, I will.' / 'No, I won't.'",
    vocabulary: [
      {
        word: "Promise",
  ...
  },
  {
    ...
    grammarConcept:
      "Future with 'be going to': Use 'am/is/are + going to + base verb' for plans and intentions already decided, or for things you can see will happen. 'I am going to visit Delhi next week.' (planned) vs. 'Look at those clouds — it is going to rain.' (evidence-based prediction).",
    vocabulary: [
      {
        word: "Plan",
  ...
  },
  {
    ...
    grammarConcept:
      "Modal Verbs: Can (ability/permission — present), Could (ability/permission — past/polite), May (permission/possibility). Structure: Subject + modal + base verb (no -s, no -ed). 'She can swim.' / 'Could you help me?' / 'May I come in?'",
    vocabulary: [
      {
        word: "Ability",
  ...
  },
  {
    ...
    grammarConcept:
      "Should (advice/recommendation), Must (strong obligation/necessity), Have to (external obligation). 'You should exercise daily.' (advice) / 'You must carry your ID.' (rule) / 'I have to wake up early.' (obligation). Should not = bad idea. Must not = forbidden!",
    vocabulary: [
      {
        word: "Advice",
  ...
  },
  {
    ...
    grammarConcept:
      "Might (possibility — less certain than 'may'), Would (conditional / polite requests). 'I might come tomorrow.' (maybe 50%) vs. 'May I come?' (asking permission). 'Would you like some tea?' (polite offer) / 'I would love to help.' (conditional willingness).",
    vocabulary: [
      {
        word: "Possibility",
  ...
  // === Day 21-25: Conditionals, Opinions, Comparatives/Superlatives ===
  {
    ...
    grammarConcept:
      "Zero Conditional (universal truths): If + Simple Present, Simple Present. 'If you heat water, it boils.' First Conditional (real future possibility): If + Simple Present, will + base verb. 'If it rains, I will stay home.' The 'if-clause' sets the condition.",
    vocabulary: [
      {
        word: "Condition",
  ...
  },
  {
    ...
    grammarConcept:
      "Second Conditional (hypothetical / unreal present or future): If + Simple Past, would + base verb. 'If I were rich, I would travel the world.' (I am not rich — this is imaginary.) Note: Use 'were' not 'was' in formal English for all subjects. 'If I were you...'",
    vocabulary: [
      {
        word: "Imaginary",
  ...
  },
  {
    ...
    grammarConcept:
      "Opinion phrases: 'In my opinion...', 'I think / I believe / I feel that...', 'It seems to me that...'. Agreeing: 'I agree / Exactly / That's right / Absolutely.' Disagreeing politely: 'I disagree / I'm not sure about that / Actually, I think...' Always give a reason after your opinion!",
    vocabulary: [
      {
        word: "Opinion",
  ...
  },
  {
    ...
    grammarConcept:
      "Comparatives (comparing 2 things): short adjectives add -er + 'than'. 'faster than', 'taller than'. Long adjectives: 'more + adjective + than'. 'more beautiful than'. Superlatives (best in a group): 'the + adjective + est'. 'the fastest'. Or: 'the most + adjective'. 'the most intelligent'. Irregular: good→better→best, bad→worse→worst.",
    vocabulary: [
      {
        word: "Taller",
  ...
  },
  {
    ...
    grammarConcept:
      "Present Perfect (have/has + past participle): Connects past to present. Used with: 'for' (duration) and 'since' (starting point), 'ever/never', 'just', 'already', 'yet'. 'I have lived here for 5 years.' (started past, still true now.) / 'Have you ever tried sushi?' Negative: 'She has not arrived yet.'",
    vocabulary: [
      {
        word: "Ever",
  ...
  // === Day 26-30: Advanced Conversations, Formal/Informal, Review ===
  {
    ...
    grammarConcept:
      "Formal English: Used in work, official letters, exams. Full forms, formal vocabulary. 'I would like to request your assistance.' Informal: Used with friends and family. Contractions, slang, casual words. 'Can you help me out?' Key rule: Match your language to your audience — this is called 'register'.",
    vocabulary: [
      {
        word: "Formal",
  ...
  },
  {
    ...
    grammarConcept:
      "Idioms: Phrases where the literal meaning is different from the actual meaning. 'Break a leg' does not mean to actually break your leg — it means 'good luck'! Idioms make your English sound natural and fluent. They cannot be translated word-by-word.",
    vocabulary: [
      {
        word: "Break a leg",
  ...
  },
  {
    ...
    grammarConcept:
      "Formal Letter structure: 1) Sender's address 2) Date 3) Recipient's address 4) Subject 5) Salutation (Dear Sir/Madam) 6) Body (Introduction, Main content, Conclusion) 7) Closing (Yours sincerely/faithfully) 8) Signature. Email: Subject line → Greeting → Body → Sign-off. Always be clear and concise in formal writing.",
    vocabulary: [
      {
        word: "Sincerely",
  ...
  },
  {
    ...
    grammarConcept:
      "Reported Speech (Indirect Speech): Reporting what someone said. Direct: She said, 'I am tired.' Reported: She said that she was tired. Rules: Tense shifts back (am → was, will → would, can → could), pronouns change (I → she/he), time expressions change (today → that day, tomorrow → the next day). Say → said, Tell → told + object.",
    vocabulary: [
      {
        word: "Reported",
  ...
  },
  {
    ...
    sentences: [
      {
        english:
          "I have completed 30 days of English learning — I am proud of myself!",
