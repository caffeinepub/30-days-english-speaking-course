import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, m as motion, G as GraduationCap, e as House } from "./index-C_yiHTPo.js";
import { B as Badge } from "./badge-DpgT5v1f.js";
import { P as PartyPopper } from "./party-popper-Ctwnaqcn.js";
...
const categories = [
  ...
  },
  {
    ...
    label: "Party",
    labelHi: "पार्टी",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PartyPopper, { className: "w-4 h-4" }),
...
function PhrasesPage() {
  const [activeTab, setActiveTab] = reactExports.useState("outside");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(135deg, oklch(0.22 0.08 258) 0%, oklch(0.32 0.14 258) 60%, oklch(0.28 0.18 200) 100%)"
        },
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-4xl mx-auto text-center text-white", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Daily Phrases" })
                ]
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: "Everyday English sentences for every situation — in English and Hindi."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1.5", "data-ocid": "phrases.tab", children: categories.map((cat) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: cat.label.slice(0, 3) })
              ]
            },
            cat.id
          );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 12 },
        animate: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: current.label }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: current.phrases.map((phrase, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-semibold text-foreground leading-relaxed", children: phrase.en })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
